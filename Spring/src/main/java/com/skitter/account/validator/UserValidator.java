package com.skitter.account.validator;
...
public class UserValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        if (user.getDisplayName().length() < 3 || user.getDisplayName().length() > 32) {
            errors.rejectValue("displayName", "Size.userForm.displayName");
        }
